 ...
 * @property DTS\eBaySDK\Trading\Types\SellingManagerAutoRelistOptionCodeType(string) $relistCondition
 * @property DTS\eBaySDK\Trading\Types\SellingManagerAutoRelistTypeCodeType(string) $type
 */
