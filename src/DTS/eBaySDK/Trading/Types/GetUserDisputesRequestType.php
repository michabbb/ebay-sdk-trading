...
/**
 *
 * @property DTS\eBaySDK\Trading\Types\DisputeFilterTypeCodeType(string) $disputeFilterType
 * @property DTS\eBaySDK\Trading\Types\DisputeSortTypeCodeType(string) $disputeSortType
