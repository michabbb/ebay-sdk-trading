 ...
 * @property DTS\eBaySDK\Trading\Types\AccessRuleCurrentStatusCodeType(string) $ruleCurrentStatus
 * @property DTS\eBaySDK\Trading\Types\AccessRuleStatusCodeType(string) $ruleStatus
 */
